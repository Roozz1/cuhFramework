...
if host then
    ...
    if char then
        ...
        cuhFramework.animation.createAnimation(cuhFramework.utilities.matrix.offsetPosition(pos, 0, 0, 10), matrix.translation(0, 0, 0), 0.1, true, function(animation)
            ...
            char:teleport(animation.properties.current_pos)
        end)
    end
end